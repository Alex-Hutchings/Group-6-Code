...
$query = 'SELECT * FROM LECTURERS_IN_MODULE WHERE Lecturer_ID="'.$username.'"'; //$_SESSION['username']
...
<div class='container'>
    <div class='well modules-buttons'>
        <input hidden type='text' id='username' name='username' value= ".$username."><a href='modulesLecturer.php?id=".$row1['Module_ID']." '><button class='btn-lg'>".$row1['Module_ID'],": ", $moduleTitle."</button></a><br>
